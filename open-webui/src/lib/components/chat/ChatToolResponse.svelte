<script lang="ts">
	...
	import { mobile, showToolResponse, showControls, showCallOverlay, showOverview, showArtifacts } from '$lib/stores';

	import Modal from '../common/Modal.svelte';
	import ToolResponse from './ToolResponse/ToolResponse.svelte';
	...
	{:else}
		...
		<Pane
			...
			onResize={(size) => {
				...
				if ($showToolResponse && pane.isExpanded()) {
					if (size < minSize) {
						pane.resize(minSize);
					}
